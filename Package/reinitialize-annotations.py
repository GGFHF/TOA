...
'''
This program deletes all annotations previously inserted into a TOA database.
'''
...
def main(argv):
    ...
    # Drop the table "blast"
    xlib.Message.print('verbose', 'Dropping the table "blast" ...\n')
    xsqlite.drop_blast(conn)
    xlib.Message.print('verbose', 'The table is dropped.\n')
...
def build_parser():
    ...
    description = 'Description: This program deletes all annotations previously inserted into a TOA database.'
